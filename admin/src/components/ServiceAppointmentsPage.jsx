...
import {  SearchIcon, XIcon ,Loader2,User,Phone,BadgeIndianRupee,Calendar,Clock, CheckCircle} from "lucide-react";
...
function RescheduleButton({ appointment, onReschedule, disabled }) {
  ...
  //to cancel the appointment/a booking
  function cancel() {
    const baseDate = appointment.date || "";
    const restoreDate =
...
onClick={() => setSearch("")}> <XIcon className={serviceAppointmentsStyles.clearSearchIcon}/></button>):null}
      </div>
    </label>
<select
              value={statusFilter}
