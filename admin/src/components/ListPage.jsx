...
//this funtion will normalize schedule map:ex- 'YYYY-MM-DD':[slot1,slot2....];
...
const displayed = useMemo(() => {
 ...
 async function removeDoctor(id) {
  ...
  //shows all doctors or the filter ones
...
<div className={doctorListStyles.doctorDetails}>{doc.specialization} . {doc.experience} years    
</div>
</div>
