...
import {Users, Search,BadgeIndianRupee, Calendar, CheckCircle, ClipboardList, XCircle } from 'lucide-react';
...
async function fetchServices({ showLoading = true } = {}) {
  ...
  //makes sure that service are present over here
  useEffect(() => {
    ...
    //a polling while tab is visible over here
    ...
    //refresh the page  and make sure the onfocus on over here
    function onFocus() {
      fetchServices({ showLoading: false });
    }
    ...
    // refresh the localstorage /it will just  store the service booking updated inside the local storage here
    ...
    // it will also change the visibility using this function 
    // and also refresh the tab when become visible here
