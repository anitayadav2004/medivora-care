...
//helper functions
//this function will convert time to 12hr  number of minutes since midnight
//and return AM :PM
...
console.log("AGGREGATE RESULT:", JSON.stringify(docs, null, 2));
...
export async function updateDoctor(req, res) {
  try {
    ...
    //if exits then update the image else show a warning
    if (req.file?.path) {
      const uploaded = await uploadToCloudinary(req.file.path, "doctors");
      if (uploaded) {
