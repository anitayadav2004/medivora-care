...
export const bannerStyles = {
  ...
  featureItem: "flex items-center justify-center lg:justify-start bg-linear-to-br from-blue-500 to-green-200 backdrop-blur-sm p-3 rounded-full shadow-sm border",
  ...
  featureBorderBlue: "border-green-100",
  ...
  bookButton: "group relative lg:whitespace-nowrap bg-linear-to-r from-blue-500 to-emerald-300 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-full font-semibold transform transition-all duration-300 shadow-2xl hover:shadow-3xl overflow-hidden text-sm sm:text-base",
...
export const certificationStyles = {
  // Container styles
  container: "relative py-6 bg-linear-to-brfrom-emerald-50 via-blue-50 to-teal-50 overflow-hidden",
  ...
  titleText: "bg-linear-to-br from-blue-600 via-teal-600 to-emerald-600 bg-clip-text text-transparent",
...
export const footerStyles = {
  // Main container
  footerContainer: "relative font-serif bg-linear-to-br from-emerald-50 via-blue-50 to-teal-50 border-t border-emerald-200 overflow-hidden",
...
export const homeDoctorsStyles = {
  // Section container
  section: "py-10 bg-linear-to-br from-blue-50 to-green-50",
...
export const navbarStyles = {
  ...
  navItemInactive: "text-blue-700 hover:text-emerald-600",
  ...
  loginButton: "btn-login hidden lg:flex lg:text-sm items-center gap-2 bg-linear-to-r from-emerald-400 to-blue-600 text-white px-6 py-2.5 rounded-full font-semibold hover:shadow-xl transition-all duration-300 cursor-default",
  loginIcon: "w-4 h-4",
