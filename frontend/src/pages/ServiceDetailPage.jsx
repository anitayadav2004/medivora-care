...
const DEFAULT_HOST = "https://medivora-care-backend.onrender.com".replace(/\/$/, "");
...
// finite number greater than 0 and less then 150
  const isValidAge = (a) => {
...
//basic validation
  ...
  //checks is form valid by field are filled or not
...
//fetch the service from the server
  ...
  function sortServiceDates(datesArr) {
    ...
    const past = parsed
      ...
      .sort((a, b) => dateVal(b.date) - dateVal(a.date)); // nearest past first decending order
