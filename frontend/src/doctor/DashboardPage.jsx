...
// that to fetching the content backend to frontend
...
//handling the status (server side and reflect on the admin panel)
...
// to get these details from the server side
...
export default function DashboardPage({ apiBase }) {
  const params = useParams(); // for the unique id
  const location = useLocation();

  const [appointments, setAppointments] = useState([]);//appt coming from server side here
