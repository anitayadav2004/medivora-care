...
import { Medal, MousePointer2Off, Search, X, ChevronRight, CircleChevronUp, CircleChevronDown } from "lucide-react";
...
const DoctorsPage = () => {
  ...
  //Load doctors coming from thr server
  useEffect(() => {
    let mounted = true;
    async function load() {
      setLoading(true);
