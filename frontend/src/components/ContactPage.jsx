...
//to submit data to whatsApp
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/7905028724?text=${encodeURIComponent(text)}`;
...
<div className={contactPageStyles.infoContainer}>
  <div className={contactPageStyles.infoCard}>
    ...
    <p className={contactPageStyles.infoText}>
      Sarahari, Gorakhpur, Uttar Pradesh
      </p>
      <p className={contactPageStyles.infoItem}>
        <Phone size={16}/> 7905028724
      </p>
      <p className={contactPageStyles.infoItem}>
       ...
       <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d33032.196811200294!2d83.35454701314899!3d26.912617782208468!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39914ea78a28fddb%3A0x3129f4dfd002a8ca!2sSarahari%2C%20Uttar%20Pradesh%20273165!5e0!3m2!1sen!2sin!4v1782194580658!5m2!1sen!2sin"
